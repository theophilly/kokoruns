...
export default function AssociationGalleryTab({ data }) {
    const theme = useTheme();
    ...
    return (
        ...
        >
            ...
            {data.length !== 0 ? (
                ...
                >
                    {data.map((item) => (
                        <Picturebox2 from="associationgalleries" {...item} />
                    ))}
                </Box>
            ) : (
                            ...
                            <Grid item xs={12}>
                                <Formik
                                    ...
                                    onSubmit={async (values) => {
                                        ...
                                        api.createAssociationGallery(associations[0]?.association_id, formData);
