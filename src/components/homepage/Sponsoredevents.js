    ...
    <Box className={sponsor_box}>
      ...
      <Box>
        <Typography className={sponsor_details}>
          The annual career fair and exhibition by organized by Access Bank
          Plc., will hold on the 24th of December, 2021. Venue: Radisson Blu,
          Issac John Street, Ikeja. The fair is aimed to expose recent graduates
          to the opportunities...Read more.
        </Typography>
      </Box>
    </Box>
  );
