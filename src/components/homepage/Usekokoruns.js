...
export default function Usekokoruns() {
    const { root, first_div, first_div_heading, list_title, usekokoruns_register, information_box, information_box_list } = useStyles();
    return (
        <Box className={root}>
            <Box className={first_div}>
                <Typography className={first_div_heading}>Who can use Kokoruns?</Typography>
            </Box>
            ...
            <Button disableElevation className={usekokoruns_register} variant={'contained'}>
                Register
            </Button>
        </Box>
    );
