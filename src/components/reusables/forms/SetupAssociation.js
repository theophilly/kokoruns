        ...
        <Box sx={{ marginTop: '0px', padding: '20px', background: 'white' }}>
            <Grid container spacing={2}>
                ...
                <Grid sx={{ paddingLeft: matches ? '40px' : '0px' }} item xs={12} md={6}>
                    <Textfield name="association_type" helpertext="Type of association" />
                </Grid>
                <Grid
                    sx={{
                        paddingRight: '40px',
                    ...
                    md={6}
                >
                    <Textfield name="association_nam" helpertext="Educational Level" />
                </Grid>
                <Grid sx={{ paddingLeft: matches ? '40px' : '0px' }} item xs={12} md={6}>
                ...
                <Grid sx={{ paddingLeft: matches ? '40px' : '0px' }} item xs={12} md={6}>
                    <Textfield name="association_size" helpertext="Student Population" />
                </Grid>
                <Grid
                    sx={{
                        paddingRight: '40px',
